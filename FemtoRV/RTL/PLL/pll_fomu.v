 ...
 */
 ...
 module femtoPLL #(
   ...
   generate
     ...
     20: begin
      parameter DIVR = 4'b0010;
      parameter DIVF = 7'b0100111;
      parameter DIVQ = 3'b101;
      parameter FILTER_RANGE = 3'b001;
     end
     24: begin
      parameter DIVR = 4'b0000;
      parameter DIVF = 7'b0001111;
      parameter DIVQ = 3'b101;
      parameter FILTER_RANGE = 3'b100;
     end
     25: begin
      parameter DIVR = 4'b0010;
     ...
     30: begin
      parameter DIVR = 4'b0000;
      parameter DIVF = 7'b0010011;
      parameter DIVQ = 3'b101;
      parameter FILTER_RANGE = 3'b100;
     end
     35: begin
      parameter DIVR = 4'b0010;
      parameter DIVF = 7'b0100010;
     ...
     75: begin
      parameter DIVR = 4'b0001;
      parameter DIVF = 7'b0011000;
      parameter DIVQ = 3'b011;
      parameter FILTER_RANGE = 3'b010;
     end
     80: begin
      parameter DIVR = 4'b0010;
      parameter DIVF = 7'b0100111;

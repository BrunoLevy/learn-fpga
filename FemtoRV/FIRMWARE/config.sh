...
# If you use this one, you may need to also uncomment "missing things" in LIBFEMTOC/makeit.sh
#
...
RVOBJDUMP=$TOOLCHAIN_DIR/riscv64-unknown-elf-objdump
RVGCC=$TOOLCHAIN_DIR/riscv64-unknown-elf-gcc
ADDITIONAL_LIB="$TOOLCHAIN_DIR/../riscv64-unknown-elf/lib/"$ARCH"/ilp32/libc.a \
                $TOOLCHAIN_DIR/../riscv64-unknown-elf/lib/"$ARCH"/ilp32/libm.a \

...
then
  ...
  riscv64-linux-gnu-as -march=rv32i -mabi=ilp32 -o BUILD/firmware.o $1
   ...
   then
      ...
      riscv64-linux-gnu-gcc-10 -Os -fno-pic -march=rv32im -mabi=ilp32 -ILIB -S $1 -o BUILD/firmware.s
      riscv64-linux-gnu-gcc-10 -Os -fno-pic -march=rv32im -mabi=ilp32 -ILIB -c -o BUILD/firmware.o $1
   else

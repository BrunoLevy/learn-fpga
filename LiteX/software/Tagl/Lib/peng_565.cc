...
#define GENPE_CLASS PolygonEngine_565
#define GENPE_DLD   init_peng_565
#define GENPE_BYTES_PER_PIXEL 2
#define GENPE_R_SHIFT 11
#define GENPE_G_SHIFT 6
#define GENPE_B_SHIFT 0
#define GENPE_R_MASK  (31 << 11)
#define GENPE_G_MASK  (63 << 5)
#define GENPE_B_MASK   31
